...
class CNN:
    def __init__(self, hyperparameters):
        ...
        self.nC = nC        # number of convolution layers
        self.nP = nP        # number of pooling layers
        self.nF = nF        # number of fully connected layers
        self.c_nf = c_nf    # number of filters in the convolutional layer
        self.c_fs = c_fs    # size of filter/kernel in the convolutional layer
        self.c_pp = c_pp    # padding (valid or same) requirement in the convolutional layer
        self.c_ss = c_ss    # size of stride in the convolutional layer
        self.p_fs = p_fs    # size of a filter in the max pooling layer
        self.p_ss = p_ss    # size of stride in the max-pooling layer
        self.p_pp = p_pp    # padding pixels in pooling layer
        self.op = op        # number of output neurons in the fully connected layer
